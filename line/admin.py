...
from .utils import line_multicast, line_push
...
from .utils import TourOfferingState, BookingState
...
class TourOfferingAdmin(admin.ModelAdmin):
    ...
    def default_tour_fee(self, booking_obj, tourOffering_obj):
        return booking_obj.adult_num * tourOffering_obj.price + 0.8 * booking_obj.child_num * tourOffering_obj.price
    ...
    def confirm(self, request, tour_offering_id):
    ...
    def cancel(self, request, tour_offering_id):
        obj = self.get_object(request, tour_offering_id)
...
class BookingAdmin(admin.ModelAdmin):
    ...
    def paid(self, request, booking_id):
